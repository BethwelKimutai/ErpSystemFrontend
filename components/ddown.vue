<template>
    <ul class="fixed top-4 right-4 flex flex-col gap-2 max-w-[280px] mx-auto mt-24 z-50">
      ...
      <li>
          <details class="group">
              ...
              <article class="absolute px-4 pb-4 bg-white border rounded shadow-lg top-full right-0 mt-2">
