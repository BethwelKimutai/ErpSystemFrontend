<template>
    <div class="border-green bg-green-light-6 flex w-full rounded-lg border-l-[6px] px-7 py-8 md:p-9">
      <div
        class="bg-green mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-md"
      >
        <svg
          width="18"
          height="18"
      ...
      <div class="w-full">
        <h5 class="mb-3 text-lg font-semibold text-[#004434]">Message Sent Successfully</h5>
